...
namespace Fanword.Shared.Helpers
{
    public class TutorialHelper
    {
		...
		public static TutorialHelper FindFavorites => new TutorialHelper() { AndroidIcon = "SearchOrange", Icon = "IconSearchOrange", Id = "Find Favorites", Title = "Find Favorites", Subtitle = "To begin with, you should pick some profiles that you would like to follow and add to your feed. Use the \"search\" or click the menu to add new profiles." };
